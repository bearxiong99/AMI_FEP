...
public class Service1Locator extends org.apache.axis.client.Service implements cn.hexing.em.client.Service1 {
    ...
    private java.lang.String Service1Soap_address = "http://localhost:1700/Service1.asmx";
    ...
    public cn.hexing.em.client.Service1Soap getService1Soap() throws javax.xml.rpc.ServiceException {
    ...
    public cn.hexing.em.client.Service1Soap getService1Soap(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            cn.hexing.em.client.Service1SoapStub _stub = new cn.hexing.em.client.Service1SoapStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (cn.hexing.em.client.Service1Soap.class.isAssignableFrom(serviceEndpointInterface)) {
                cn.hexing.em.client.Service1SoapStub _stub = new cn.hexing.em.client.Service1SoapStub(new java.net.URL(Service1Soap_address), this);
                _stub.setPortName(getService1SoapWSDDServiceName());
                return _stub;
            }
        }
