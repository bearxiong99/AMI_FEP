				...
				if(fp!=null && dic!=null){
					...
					switch(dic.getParserno()){
						...
						case 54:
							...
							break;	
						case 55:
							slen=Parser55.constructor(frame,value,loc,dic.getLength(),dic.getFraction());
							break;	
						case 56:
							slen=Parser56.constructor(frame,value,loc,dic.getLength(),dic.getFraction());
							break;	
						case 57:
							slen=Parser57.constructor(frame,value,loc,dic.getLength(),dic.getFraction());
							break;	
						case 58:
							slen=Parser58.constructor(frame,value,loc,dic.getLength(),dic.getFraction());
							break;	
						case 59:
							slen=Parser59.constructor(frame,value,loc,dic.getLength(),dic.getFraction());
							break;	
						case 71:
							slen=Parser71.constructor(frame, value, loc, dic.getLength(), dic.getFraction());
							break;
						default:
