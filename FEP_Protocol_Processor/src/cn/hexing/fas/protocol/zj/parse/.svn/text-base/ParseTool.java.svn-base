...
public class ParseTool {
	...
	public static final double FRACTION_TIMES_100000=100000.0;
	public static final double FRACTION_TIMES_1000000=1000000.0;
	public static final double fraction[]=new double[]{1.0,FRACTION_TIMES_10,FRACTION_TIMES_100,FRACTION_TIMES_1000,FRACTION_TIMES_10000,FRACTION_TIMES_100000,FRACTION_TIMES_1000000};
     ...
     * @return
     */
    public static String getDataString(IMessage message){
    	String rt=null;
    	try{		
     ...
     * @return YYMMDDHH
     */
    public static String getTime(byte[] data,int loc,int len){
		StringBuffer sb=new StringBuffer();
     ...
     * @return HHmm 或 MMdd
     */
    public static String getTime2Byte(byte[] data,int loc){
    	int len = 2;
    	StringBuffer sb = new StringBuffer();
